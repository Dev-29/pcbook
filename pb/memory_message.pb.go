...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=dev29.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x64, 0x65, 0x76, 0x32, 0x39, 0x2e, 0x70, 0x63, 0x62, 0x6f,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: dev29.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: dev29.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: dev29.pcbook.Memory.unit:type_name -> dev29.pcbook.Memory.Unit
